<x-guest-layout>
  <div class="md:mt-20 justify-center bg-white sm:items-center sm:pt-0 py-20">
    <div class="container mx-auto flex-wrap h-full px-2 md:px-4 lg:px-40 text-gray-800">
      <div class="block bg-white shadow-lg rounded-lg">
        <div class="flex flex-wrap w-full">
          <div class="w-full md:w-6/12 lg:rounded-l-lg rounded-b-lg lg:rounded-br-none bg-no-repeat bg-center bg-cover" style="background-image: url('../assets/img/govtech.jpg')"></div>
          <div class="mt-2 md:mt-0 w-full md:w-6/12 px-4 md:px-0 bg-gray-100">
            ...
            <div class="p-2 md:py-6 md:mx-6">
              ...
              <form method="POST" action="{{ route('login') }}">
                  ...
                  <div class="my-4">
                      ...
                      <x-jet-button class="་་mt-4 w-full px-4 bg-sky-500 hover:bg-sky-700 justify-center {{ app()->getLocale()=='dz' ? 'font-dz text-xl' : 'text-sm' }}">
                          {{ __('Log in') }}
                      </x-jet-button>
                  </div>
              </form>
