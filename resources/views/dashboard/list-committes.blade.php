        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
          <li aria-current="page">
            <div class="flex items-center">
              <span class="ml-1 font-medium text-gray-700 md:ml-2">Committee Documents</span>
            </div>
          </li>
        </ol>
      </nav>
      ...
      <div class="p-4 mt-4 border border-gray-100 rounded md:my-10">
        <div class="grid gap-4 grid-col1 md:grid-cols-4">
          @foreach ($committees as $item)
            <a href="{{ route('app.committee.documents', $item->id)}}" class="flex items-center w-full my-4">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
          <li>
            <div class="flex items-center text-yellow-500">
              ...
              <a href="#" class="ml-1 font-medium text-gray-700 hover:text-gray-900 md:ml-2">Committees Documents</a>
            </div>
          </li>
        </ol>
      </nav>
