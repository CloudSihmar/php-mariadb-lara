      ...
      <div class="mt-6">
       <div class="bg-white overflow-hidden shadow sm:rounded-lg">
          ...
          <div class="w-full overflow-hidden rounded-lg shadow-xs">
              ...
              <table class="w-full whitespace-no-wrap">
                <thead>
                  <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b bg-gray-50">
                    <th class="px-2 py-3">Constituency</th>
                    <th class="px-2 py-3">Short Desc</th>
                    <th class="px-2 py-3 text-right">Actions</th>
                  </tr>
                </thead>
                <tbody class="bg-white divide-y">
                  @foreach($constituencies as $index=>$item)
            ...
            <div class="px-2 py-3 my-4 text-xs  tracking-wide text-gray-500 uppercase border-t bg-gray-50 min-h-min">
               {{ $constituencies->links()}} 
            </div>
          </div>
        </div>
        <!-- Add/Edit Modal -->
        @include('livewire.admin.constituencies.partials._add')
          <!--Delete Modal -->
        @include('livewire.admin.constituencies.partials._delete')
      </div>
  </div>
</div>
