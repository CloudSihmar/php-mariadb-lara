  ...
  <div class="w-11/12 p-2 mx-auto">
    <nav class="flex items-center justify-between w-full p-3 my-2 font-sans font-medium bg-gray-100 rounded">
      <ol class="flex list-reset text-grey-dark">
        ...
        <li><a href="{{ route('admin.secretariat.document.categories') }}" class="hover:underline">Secretariat Document Categories</a></li>
        <li><span class="mx-2">/</span></li>
        <li class="text-gray-500">{{ \App\Models\Admin\Division::findOrFail($this->divID)->name }}</li>
      </ol>
      ...
      <div class="mt-6">
       <div class="overflow-hidden bg-white shadow sm:rounded-lg">
        ...
        <!-- Add/Edit Modal -->
        @include('livewire.admin.divisiontsubcategory.partials._add')
          <!--Delete Modal -->
        @include('livewire.admin.divisiontsubcategory.partials._delete')
      </div>
  </div>
</div>
