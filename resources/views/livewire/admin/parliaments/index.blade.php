     ...
     <nav class="flex justify-between px-5 py-3 mt-4 text-gray-700 border border-gray-200 rounded-lg bg-gray-50" aria-label="Breadcrumb">
      ...
      <div class="mx-auto mt-6">
       <div class="overflow-hidden bg-white shadow sm:rounded-lg">
              ...
              <table class="w-full whitespace-no-wrap">
                <thead>
                  <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b bg-gray-50">
                    <th class="px-4 py-3">Parliament</th>
                    <th class="px-4 py-3">Parliament Sessions</th>
                ...
                <tbody class="bg-white divide-y">
                  ...
                  <tr class="text-gray-700">
                    ...
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <a href="{{ route('admin.parliament.session', $item->id)}}" class="text-sm">
                          <i class="mr-2 text-yellow-500 fa fa-folder-plus fa-lg"></i> Sessions - [ {{ $item->parliamentsessions->count() }} ]
                        </a>
                      </div>
                    </td>
                     ...
                     <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <a href="{{ route('admin.parliament.committees', $item->id)}}" class="text-sm">
                          <i class="mr-2 text-yellow-500 fa fa-folder-plus fa-lg"></i> Committees - [ {{ $item->committees->count() }} ]
                        </a>
                      </div>
                    </td>
        ...
        <!-- Add/Edit Modal -->
        @include('livewire.admin.parliaments.partials._add')
          <!--Delete Modal -->
        @include('livewire.admin.parliaments.partials._delete')
      </div>
  </div>
</div>
