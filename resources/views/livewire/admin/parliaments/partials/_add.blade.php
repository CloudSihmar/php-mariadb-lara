          ...
          <x-slot name="content">
              <div class="mt-4">
                  <div class="col-span-6 sm:col-span-4">
                      <x-jet-label for="name" value="{{ __('Parliament Name') }}" />
                      <x-jet-input type="text" class="mt-1 block w-full" wire:model.lazy="parliament.name" />
                      <x-jet-input-error for="parliament.name" class="mt-2" />
                  </div>
              </div>
