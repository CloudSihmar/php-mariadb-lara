...
<div class="my-6">
  <h1 class="py-2 font-bold text-xl text-cyan-600">Secretariat Daily Attendance Report</h1>
  @if (auth()->user()->can('secretariat.dailyattendancereport'))
      <div class="w-full overflow-x-auto">
          @include('livewire.attendancereports._dailysearchbar')
          <div class="w-full">
              <div class="bg-gray-100 shadow p-3 text-gray-600">
                  <table class="w-full whitespace-no-wrap">
                      ...
                      <tr class="text-gray-500">
                          ...
                          @php
                          $result = $this->staffAttendanceRecord($item->id);
                          @endphp
                          @if(count($result) > 0)
                          <td class="px-2 py-3">
                              <div class="flex items-center text-sm">
