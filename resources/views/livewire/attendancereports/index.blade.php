<div class="my-6">
    <h1 class="py-2 font-bold text-xl text-cyan-600">Staff Attendance Report</h1>
            ...
            <div class="bg-gray-100 w-full shadow p-3 ml-3 text-xs text-gray-600">
                <div class="bg-gray-300 p-3 rounded font-bold text-gray-800 leading-tight">Legend</div>
                 <div class="grid grid-cols-4 mt-4 gap-1">
                   <span class="bg-green-400 px-2 py-2 rounded text-xs text-gray-600" style='background-color:#7ae69f;'>Weekend</span>
                    ...
                    <span class="bg-red-500 px-2 py-2 rounded text-xs text-gray-600" style='background-color:#d16460;'>Absent</span>
                    <span class="bg-cyan-600 px-2 py-2 rounded text-xs text-gray-600" style='background-color:#287877;'>Holiday</span>
                    <span class="bg-yellow-500 px-2 py-2 rounded text-xs text-gray-600" style='background-color:#f7e40f;'>Today</span>
                </div> 
