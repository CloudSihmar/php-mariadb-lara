 <!-- Show add/Edit Modal -->
      <x-jet-dialog-modal wire:model="checkoutFormModal">
          <x-slot name="title">
              <span class="font-bold uppercase text-red-500"> Are you sure to CheckOut Now?</span>
          </x-slot>
          ...
          <x-slot name="content">
            ...
            <div class="mt-4">
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="name" value="{{ __('Check Out Date Time') }}" />
                    @php
          ...
          <x-slot name="footer">
            ...
            <x-jet-button class="ml-2 bg-blue-400 hover:bg-blue-300 hover:text-gray-700" wire:click="checkoutForm" wire:loading.attr="disabled">
                {{ __('CheckOut') }}
            </x-jet-button>
          </x-slot>
      </x-jet-dialog-modal>