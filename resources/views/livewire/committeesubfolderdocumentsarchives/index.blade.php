        ...
        <div class="pl-4">
          ...
          <div class="flex flex-row items-center justify-start gap-4 mt-4 ml-6 ">
                <div class="flex items-center justify-start relative group ">
                  <a href="{{ route('app.committee.document.archives', $this->parID)}}">
                    ...
                    <tr>
                      ...
                      <td class="flex justify-end gap-2 p-4 px-6 text-xs border-t border-l-0 border-r-0 whitespace-nowrap">
                        <div class="flex flex-row gap-2">
                              ...
                              @include('livewire.committeesubfolderdocumentsarchives.partials._viewDoc')
                            </div> 
                      </td>
                    </tr>
                    @empty
