<x-jet-dialog-modal wire:model="confirmItemEdit">
    <x-slot name="title">
        <div class="col-span-6 sm:col-span-4">
            <span class="font-bold uppercase"> {{ isset( $this->holidayapp->id) ? 'UPDATE HOLIDAY' : '' }}</span>
        </div>
        ...
        <div class="mt-4">
            <div class="col-span-6 sm:col-span-4">
                <x-jet-label for="holiday_date" value="{{ __('Holiday Date') }}" />
                    <input type="text" x-data x-init="new Pikaday({ field: $el, format:'YYYY-MM-DD' })" class="form-control" wire:model.lazy="holidayapp.holiday_date"/>
