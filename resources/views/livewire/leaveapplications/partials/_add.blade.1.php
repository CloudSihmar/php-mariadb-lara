<x-jet-dialog-modal wire:model="confirmItemAdd">
    <x-slot name="title">
        ...
        <div class="flex items-center bg-gray-200 rounded p-2 mt-2 col-span-6 sm:col-span-4">
            <i class="fa fa-info-circle fa-lg text-blue-600 mr-2"></i> 
             <span class="text-sm">
               Annaul Leave Balance:<strong> {{$this->eLeaveBalance}} </strong> &nbsp;&nbsp;
