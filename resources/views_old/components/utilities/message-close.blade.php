    ...
    <div class="flex items-center justify-between max-w-xl p-4 bg-white border rounded-md shadow-sm space-x-4">
        <div class="flex items-center">
            ...
            <p class="ml-3 text-sm font-bold text-green-600">{{ session()->get('message') }}</p>
        </div>
