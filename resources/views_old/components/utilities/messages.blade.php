@if (session()->has('message'))
    <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-gray-50 rounded-lg shadow-md dark:bg-gray-800 my-4">
...
@if (session()->has('error'))
    <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-gray-50 rounded-lg shadow-md dark:bg-gray-800 mt-4">
