     ...
     <nav class="flex justify-between px-5 py-3 mt-4 text-gray-700 border border-gray-200 rounded-lg bg-gray-50" aria-label="Breadcrumb">
      ...
      <div class="mt-6">
       <div class="bg-white overflow-hidden shadow sm:rounded-lg">
                ...
                <tbody class="bg-white divide-y">
                  ...
                  <tr class="text-gray-700">
                    <td class="px-4 py-3">
                     ...
                     <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <a href="{{ route('admin.agency.departments', $item->id)}}" class="bg-sky-500 px-4 py-2 rounded-full text-white text-sm">
                          <i class="fa fa-border-all fa-lg mr-2"></i>departments ( {{ $item->departments->count()}} )
                        </a>
                      </div>
                    </td>
        ...
        <!-- Add/Edit Modal -->
        @include('livewire.admin.agency.partials._add')
          <!--Delete Modal -->
        @include('livewire.admin.agency.partials._delete')
      </div>
  </div>
</div>
