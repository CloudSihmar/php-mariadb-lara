       ...
       <div class="bg-white overflow-hidden shadow sm:rounded-lg">
          ...
          <div class="w-full overflow-hidden rounded-lg shadow-xs">
            <div class="w-full overflow-x-auto">
              <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y">
                  @foreach ($conferencehalls as $item)
            ...
            <div class="px-4 py-3 my-4 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t bg-gray-50 min-h-min">
              {{ $conferencehalls->links()}}
            </div>
          </div>
        </div>
        <!-- Add/Edit Modal -->
        @include('livewire.admin.conferencehalls.partials._add')
          <!--Delete Modal -->
        @include('livewire.admin.conferencehalls.partials._delete')
      </div>
  </div>
</div>
