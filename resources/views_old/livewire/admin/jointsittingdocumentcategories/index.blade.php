  ...
  <div class="w-11/12 p-2 mx-auto">
    <nav class="flex justify-between px-5 py-3 mt-4 text-gray-700 border border-gray-200 rounded-lg bg-gray-50" aria-label="Breadcrumb">
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li>Joint Sitting Document Category</li>
      </ol>
      ...
      <div class="mt-6">
       <div class="overflow-hidden bg-white shadow sm:rounded-lg">
              ...
              <table class="w-full whitespace-no-wrap">
                <thead>
                  <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b bg-gray-50">
                    <th class="px-4 py-3">Document Category Name</th>
                ...
                <tbody class="bg-white divide-y">
                  ...
                  <tr class="text-gray-700 hover:bg-gray-100">
                    <td class="px-4 py-3">
                       <a href="{{ route('admin.joint.session.doc.subfolders', $item->id)}}">
        ...
        <!-- Add/Edit Modal -->
        @include('livewire.admin.jointsittingdocumentcategories.partials._add')
          <!--Delete Modal -->
        @include('livewire.admin.jointsittingdocumentcategories.partials._delete')
      </div>
  </div>
</div>
