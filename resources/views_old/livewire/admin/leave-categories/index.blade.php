     ...
     <nav class="flex justify-between px-5 py-3 mt-4 text-gray-700 border border-gray-200 rounded-lg bg-gray-50" aria-label="Breadcrumb">
      ...
      <div class="mx-auto mt-6">
       <div class="bg-white overflow-hidden shadow sm:rounded-lg">
              ...
              <table class="w-full whitespace-no-wrap">
                <thead>
                  <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b bg-gray-50">
                    ...
                    <th class="px-4 py-3">Leave Code</th>
                    <th class="px-4 py-3">Description</th>
                    <th class="px-4 py-3 text-right">Actions</th>
                  </tr>
                </thead>
                <tbody class="bg-white divide-y">
                  @foreach($leavecategories as $item)
        ...
        <!-- Add/Edit Modal -->
        @include('livewire.admin.leave-categories.partials._add')
          <!--Delete Modal -->
        @include('livewire.admin.leave-categories.partials._delete')
      </div>
  </div>
</div>
