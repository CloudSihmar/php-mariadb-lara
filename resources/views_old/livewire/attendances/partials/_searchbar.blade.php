<div class="w-full bg-gray-100 p-2 my-4 rounded shadow">
  <div class="flex w-full flex-col md:flex-row items-center justify-between gap-4">
    <div class="flex flex-col md:flex-row gap-2 w-full">
      ...
      @if(in_array($user_division,[5,6,7]))
        <div class="flex items-center flex-row gap-2 w-full">
          ...
          <a class="flex items-center py-2 px-6 text-white rounded bg-blue-600 hover:bg-blue-500 text-xs uppercase font-bold" href="{{ route('app.report.attendancereport.applications',9)}}">
