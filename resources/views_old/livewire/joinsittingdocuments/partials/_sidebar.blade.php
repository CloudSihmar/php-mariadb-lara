      ...
      <div class="w-full">
        <nav class="flex flex-col pt-10 ml-2 mr-4 overflow-hidden md:pt-2">
           @foreach ($categories as $item)
            <a href="{{ route('app.joint.sitting.documents', [$this->sID, $item->id])}}" class="flex items-center p-2 my-1 space-x-1 text-sm rounded-md hover:bg-gray-100 hover:text-blue-600">
