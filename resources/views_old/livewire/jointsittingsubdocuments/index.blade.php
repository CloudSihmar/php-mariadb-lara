<div>
   <!-- Breadcrumb -->
      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li aria-current="page">
          <div class="flex items-center">
            ...
            <span class="ml-1 text-sm font-medium text-gray-700 md:ml-2">Joint Sitting</span>
          </div>
        </li>
      </ol>
    </nav>
    ...
    <div x-data="{ sidebarOpen: false}">
            ...
            <div class="h-5 text-2xl text-center border-b-2 border-sky-500">
             ...
             <div class="flex flex-row items-center justify-start gap-4 my-2">
              <div class="flex items-center justify-start group">
                <a href="{{ route('app.joint.sitting.documents', [$this->sID, $this->dirID])}}">
                  <i class="text-yellow-500 fa fa-level-up-alt fa-lg"></i>
                </a>
                <span class="absolute w-16 px-2 py-1 m-4 mx-auto text-xs text-center text-gray-100 transition-opacity -translate-x-2 translate-y-full bg-gray-500 rounded opacity-0 group-hover:opacity-100">Level up</span>
              </div>
      ...
      @include('livewire.jointsittingsubdocuments.partials._add')
      @include('livewire.jointsittingsubdocuments.partials._delete')
</div>
