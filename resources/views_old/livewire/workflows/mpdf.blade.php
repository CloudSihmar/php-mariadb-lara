...
<body>
    <htmlpageheader name="page-header">
      <div class="row">
          ...
          <div class="column middle">
            <div class="text-center jhomolhari fontSize-30">འབྲུག་རྒྱལ་ཡོངས་ཚོགས་འདུ།</div>
            <div class="text-center fontSize-20">NATIONAL ASSEMBLY OF BHUTAN</div>
          </div>
    ...
    @if ($tempID==1)
        @if ($language=='dz')
            <div style="padding-left:20px" class="jhomolhari pt-14 fontSize-20">ཚོགས་དཔོན།</div>
        @else
            <div class="pt-4 font-14" style="padding-left:12px">SPEAKER</div>
        @endif
        @php $phone = 'Phone: +975 2 336828/321137' @endphp
    @elseif($tempID==2)
        @if ($language=='dz')
            <div class="jhomolhari pt-4 fontSize-20">སྤྱི་ཚོགས་ཀྱི་འཐུས་མི།</div>
        @else
        <div class="pt-4 fontSize-14">
          <div style="padding-left:2px">MEMBER OF</div>
            <div>PARLIAMENT</div>
          </div>
        @endif
    ...
    @elseif($tempID==3)
        @if ($language=='dz')
            <div class="jhomolhari pt-4 fontSize-20">ལྡོག་ཕྱོགས་འགོ་ཁྲིདཔ།</div>
        @else
          <div class="pt-4 "> 
            <div style="padding-left:10px">OPPOSITION</div>
            <div style="padding-left:22px">LEADER</div>
          </div>
        @endif
    ...
    @elseif($tempID==4)
        ...
        @endif
        @php $phone = 'PABX: +975 2 328080/325131/322793' @endphp
      @elseif($tempID==5)
          <div style="padding-top:10px"></div>
          @php $phone = 'PABX: +975 2 322729/322793' @endphp 
      @endif
  ...
  <htmlpagefooter name="page-footer">
    <hr>
      <div class="footer ">
        POST BOX # 139, THIMPHU: BHUTAN, {{ $phone }} <br>
